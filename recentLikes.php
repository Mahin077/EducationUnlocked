...
$id = $_SESSION['user_id'];
$sqlShowPost = "select post.postid,user.username,post.text,post.category,post.created_at from user join post on post.userid=user.userid join likedpost on post.postid=likedpost.postid && likedpost.userid='$id'";
